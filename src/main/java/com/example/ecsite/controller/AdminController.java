...
import com.example.ecsite.model.form.UserForm;
import com.example.ecsite.model.form.UserNameForm;
...
public class AdminController {
	...
	@ResponseBody
	@PostMapping("/api/validUserName")
	public String validUserName(@RequestBody UserNameForm form) {
